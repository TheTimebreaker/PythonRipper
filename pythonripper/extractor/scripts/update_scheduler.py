...
import pythonripper.extractor.updater.update_artist_websites
import pythonripper.extractor.updater.update_artstation
import pythonripper.extractor.updater.update_danbooru
import pythonripper.extractor.updater.update_deviantart
import pythonripper.extractor.updater.update_gelbooru
import pythonripper.extractor.updater.update_hentaifoundry
import pythonripper.extractor.updater.update_hypnohub
import pythonripper.extractor.updater.update_kusowanka
import pythonripper.extractor.updater.update_newgrounds
import pythonripper.extractor.updater.update_patreon
import pythonripper.extractor.updater.update_pixiv
import pythonripper.extractor.updater.update_reddit
import pythonripper.extractor.updater.update_rule34paheal
import pythonripper.extractor.updater.update_rule34us
import pythonripper.extractor.updater.update_rule34xxx
import pythonripper.extractor.updater.update_tumblr
import pythonripper.extractor.updater.update_yandere
...
async def update_all(config: cfg.Config) -> dict[str, bool]:
    scheduler: list[tuple[Callable[[Any], Any], int]] = [  # Function, repeat every X days
        ...
        (pythonripper.extractor.updater.update_reddit.update_reddit_monthly, 0),
        (pythonripper.extractor.updater.update_yandere.update_yandere_artists, 28),
        # (updater.update_yandere.update_yandere_tags, 3),
        # ### regular priority
        (pythonripper.extractor.updater.update_artstation.update_artstation_artists, 28),
        (pythonripper.extractor.updater.update_artist_websites.update_supersatanson, 60),
        (pythonripper.extractor.updater.update_artist_websites.update_shellvi, 45),
        (pythonripper.extractor.updater.update_artist_websites.update_tangsgallery, 47),
        (pythonripper.extractor.updater.update_danbooru.update_danbooru_artists, 28),
        # (updater.update_danbooru.update_danbooru_tags, 4),
        (pythonripper.extractor.updater.update_deviantart.update_deviantart_artists, 28),
        (pythonripper.extractor.updater.update_deviantart.update_deviantart_favorites, 8),
        (pythonripper.extractor.updater.update_gelbooru.update_gelbooru_artists, 28),
        # (updater.update_gelbooru.update_gelbooru_tags, 4),
        (pythonripper.extractor.updater.update_hentaifoundry.update_hentaifoundry_artists, 28),
        (pythonripper.extractor.updater.update_hypnohub.update_hypnohub_artists, 28),
        # (updater.update_hypnohub.update_hypnohub_tags, 14),
        (pythonripper.extractor.updater.update_kusowanka.update_kusowanka_artists, 28),
        # (updater.update_kusowanka.update_kusowanka_tags, 7),
        (pythonripper.extractor.updater.update_newgrounds.update_newgrounds_artists, 28),
        (pythonripper.extractor.updater.update_newgrounds.update_newgrounds_favorites, 7),
        (pythonripper.extractor.updater.update_patreon.update_patreon_artists, 28),
        (pythonripper.extractor.updater.update_pixiv.update_pixiv_artists, 28),
        (pythonripper.extractor.updater.update_reddit.update_reddit_artists, 28),
        (pythonripper.extractor.updater.update_reddit.update_reddit_subs, 6),
        (pythonripper.extractor.updater.update_rule34paheal.update_rule34paheal_artists, 28),
        # (updater.update_rule34paheal.update_rule34paheal_tags, 7),
        (pythonripper.extractor.updater.update_rule34us.update_rule34us_artists, 28),
        # (updater.update_rule34us.update_rule34us_tags, 7),
        (pythonripper.extractor.updater.update_rule34xxx.update_rule34xxx_artists, 28),
        # (updater.update_rule34xxx.update_rule34xxx_tags, 4),
        (pythonripper.extractor.updater.update_tumblr.update_tumblr_artists, 28),
    ]
