...
import updater.update_artist_websites
import updater.update_artstation
import updater.update_danbooru
import updater.update_deviantart
import updater.update_gelbooru
import updater.update_hentaifoundry
import updater.update_hypnohub
import updater.update_kusowanka
import updater.update_newgrounds
import updater.update_patreon
import updater.update_pixiv
import updater.update_reddit
import updater.update_rule34paheal
import updater.update_rule34us
import updater.update_rule34xxx
import updater.update_tumblr
import updater.update_yandere
...
async def update_all(config: cfg.Config) -> dict[str, bool]:
    scheduler: list[tuple[Callable[[Any], Any], int]] = [  # Function, repeat every X days
        ...
        (updater.update_reddit.update_reddit_monthly, 0),
        (updater.update_yandere.update_yandere_artists, 28),
        # (updater.update_yandere.update_yandere_tags, 3),
        # ### regular priority
        (updater.update_artstation.update_artstation_artists, 28),
        (updater.update_artist_websites.update_supersatanson, 60),
        (updater.update_artist_websites.update_shellvi, 45),
        (updater.update_artist_websites.update_tangsgallery, 47),
        (updater.update_danbooru.update_danbooru_artists, 28),
        # (updater.update_danbooru.update_danbooru_tags, 4),
        (updater.update_deviantart.update_deviantart_artists, 28),
        (updater.update_deviantart.update_deviantart_favorites, 8),
        (updater.update_gelbooru.update_gelbooru_artists, 28),
        # (updater.update_gelbooru.update_gelbooru_tags, 4),
        (updater.update_hentaifoundry.update_hentaifoundry_artists, 28),
        (updater.update_hypnohub.update_hypnohub_artists, 28),
        # (updater.update_hypnohub.update_hypnohub_tags, 14),
        (updater.update_kusowanka.update_kusowanka_artists, 28),
        # (updater.update_kusowanka.update_kusowanka_tags, 7),
        (updater.update_newgrounds.update_newgrounds_artists, 28),
        (updater.update_newgrounds.update_newgrounds_favorites, 7),
        (updater.update_patreon.update_patreon_artists, 28),
        (updater.update_pixiv.update_pixiv_artists, 28),
        (updater.update_reddit.update_reddit_artists, 28),
        (updater.update_reddit.update_reddit_subs, 6),
        (updater.update_rule34paheal.update_rule34paheal_artists, 28),
        # (updater.update_rule34paheal.update_rule34paheal_tags, 7),
        (updater.update_rule34us.update_rule34us_artists, 28),
        # (updater.update_rule34us.update_rule34us_tags, 7),
        (updater.update_rule34xxx.update_rule34xxx_artists, 28),
        # (updater.update_rule34xxx.update_rule34xxx_tags, 4),
        (updater.update_tumblr.update_tumblr_artists, 28),
    ]
